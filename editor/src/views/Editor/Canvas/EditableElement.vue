  ...
  return [
    ...
    { divider: true },
    {
      ...
      children: [
        ...
        { text: 'Align center horizontally', handler: () => alignElementToCanvas(ElementAlignCommands.HORIZONTAL) },
    ...
    },
    {
      ...
      children: [
        { text: 'Align center', handler: () => alignElementToCanvas(ElementAlignCommands.CENTER) },
        { text: 'Align center vertically', handler: () => alignElementToCanvas(ElementAlignCommands.VERTICAL) },
