<template>
  <div class="element-positopn-panel">
    ...
    <ButtonGroup class="row">
      ...
      <Button style="flex: 1;" v-tooltip="'Horizontal center'" @click="alignElementToCanvas(ElementAlignCommands.HORIZONTAL)"><i-icon-park-outline:align-vertically /></Button>
    ...
    <ButtonGroup class="row">
      ...
      <Button style="flex: 1;" v-tooltip="'Vertical center'" @click="alignElementToCanvas(ElementAlignCommands.VERTICAL)"><i-icon-park-outline:align-horizontally /></Button>
...
// When setting width/height of a shape, need to check whether to update the shape path
