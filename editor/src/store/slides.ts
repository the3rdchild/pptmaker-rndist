...
export const useSlidesStore = defineStore('slides', {
  state: (): SlidesState => ({
    ...
    templates: [
      { name: 'Red Mountains', id: 'template_1', cover: './imgs/template_1.webp', origin: 'Official' },
      ...
      { name: 'Simple Green', id: 'template_5', cover: './imgs/template_5.webp', origin: 'Community contribution + official refinement' },
      { name: 'Warm Retro', id: 'template_6', cover: './imgs/template_6.webp', origin: 'Community contribution + official refinement' },
      { name: 'Deep & Steady', id: 'template_7', cover: './imgs/template_7.webp', origin: 'Community contribution + official refinement' },
      { name: 'Fresh Light Blue', id: 'template_8', cover: './imgs/template_8.webp', origin: 'Community contribution + official refinement' },
    ], // Templates
  }),
  ...
  getters: {
    ...
    // Formatted animations of the current page
    // Merges items whose trigger is "simultaneously with the previous animation" upward into the same position in the sequence
    // Adds an auto-execute-next marker to the previous item of items whose trigger is "after the previous animation"
