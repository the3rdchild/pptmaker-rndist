<template>
  <div class="text-style-panel">
    ...
    <Divider />
    <div class="row">
      <div style="width: 40%;">Fixed height:</div>
    ...
    >
      ...
      <RadioButton value="middle" v-tooltip="'Vertical center'" style="flex: 1;"><i-icon-park-outline:align-text-middle-one /></RadioButton>
...
// Note: there is a bug of unknown cause - if the text is bolded after the text box height increases, the visible area positioning of the canvas will be incorrect.
// Therefore, when executing preset style commands, place the bold command as early as possible to avoid bolding after the font size increases.
const presetStyles = [
  {
    label: 'Big title',
    style: {
...
// Send rich text setting commands (batch)
