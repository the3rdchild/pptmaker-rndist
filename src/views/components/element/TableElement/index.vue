...
// Update the editable state of the table; global shortcuts must be disabled while the table is being edited
...
// Listen for size changes of the table element; when the height changes, update the height to the store
...
// Update the table's currently selected cells
